...
# Log
LOG_PATH = join(dirname(dirname(__file__)), 'data', 'four_image_results.csv')
...
IMAGE_PATH_ACC = join(dirname(dirname(__file__)), 'images', 'four_image_results_acc.png')
IMAGE_PATH_SIM = join(dirname(dirname(__file__)), 'images', 'four_image_results_sim.png')
IMAGE_PATH_ITER = join(dirname(dirname(__file__)), 'images', 'four_image_results_iter.png')
